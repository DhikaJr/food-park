...
<head>
	...
	<!-- Plugins Stylesheet -->
	<link href="{{ asset('admin/assets/vendor/metismenu/dist/metisMenu.min.css') }}" rel="stylesheet">
	<link href="{{ asset('admin/assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css') }}" rel="stylesheet">
	<link class="main-switcher" href="{{ asset('admin/assets/css/switcher.css') }}" rel="stylesheet">

	<link href="{{ asset('admin/assets/vendor/@yaireo/tagify/dist/tagify.css') }}" rel="stylesheet">
...
<body>
	...
	<div id="main-wrapper">
								...
								<ul class="contacts">
									...
									<li class="active dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar1.webp') }}" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar2.webp') }}" class="rounded-circle user_img" alt="">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar3.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar4.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar5.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz- -user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar6.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar7.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar8.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar9.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
									...
									<li class="dz-chat-user">
										<div class="d-flex bd-highlight">
											<div class="img_cont">
												<img src="{{ asset('admin/assets/images/avatar/small/avatar10.webp') }}" class="rounded-circle user_img" alt="">
												<span class="online_icon offline"></span>
											</div>
											<div class="user_info">
							...
							<div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
										<img src="{{ asset('admin/assets/images/avatar/small/avatar1.webp') }}" class="rounded-circle user_img_msg" alt="">
									</div>
								...
								<div class="d-flex justify-content-end mb-4">
									...
									<div class="img_cont_msg">
										<img src="{{ asset('admin/assets/images/avatar/small/avatar2.webp') }}" class="rounded-circle user_img_msg" alt="">
									</div>
								</div>
								<div class="d-flex justify-content-start mb-4">
									<div class="img_cont_msg">
				...
				<div class="row">
					<div class="col-xxl-9">
						<div class="row">
							...
							<div class="col-xl-3 col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-body p-0">
										<div class="d-flex justify-content-between pb-0 px-3 pt-3">
											<div class="clearfix">
							...
							<div class="col-xl-3 col-sm-6">
								<div class="card">
									<div class="card-body d-flex align-items-center py-2 px-3 ps-0">
										<div id="AllProject"></div>
										<div class="clearfix">
											<h6>All Projects</h6>
											<div class="fs-13"><i class="fa-solid fa-square text-success me-1 fs-12"></i> Compete </div>
											<div class="fs-13"><i class="fa-solid fa-square text-primary me-1 fs-12"></i> Pending </div>
											<div class="fs-13"><i class="fa-solid fa-square text-secondary me-1 fs-12"></i> Not Start </div>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="card-body p-0">
										<div class="d-flex justify-content-between pb-0 px-3 pt-3">
											...
											<div class="avatar avatar-sm avatar-danger border-0">
												<svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
													<path d="M11.4642 13.7074C11.4759 12.1252 10.8504 10.8738 9.60279 9.99009C8.6392 9.30968 7.46984 8.95476 6.33882 8.6137C3.98274 7.89943 3.29927 7.52321 3.29927 6.3965C3.29927 5.14147 4.93028 4.69493 6.32655 4.69493C7.34341 4.69493 8.51331 5.01109 9.23985 5.47964L10.6802 3.24887C9.73069 2.6333 8.43112 2.21342 7.14783 2.0831V0H4.49076V2.22918C2.12884 2.74876 0.640949 4.29246 0.640949 6.3965C0.640949 7.87005 1.25327 9.03865 2.45745 9.86289C3.37331 10.4921 4.49028 10.83 5.56927 11.1572C7.88027 11.8557 8.81873 12.2813 8.80805 13.691L8.80799 13.7014C8.80799 14.8845 7.24005 15.3051 5.89676 15.3051C4.62786 15.3051 3.248 14.749 2.46582 13.9222L0.535522 15.7481C1.52607 16.7957 2.96523 17.5364 4.4907 17.8267V20.0001H7.14783V17.8735C9.7724 17.4978 11.4616 15.9177 11.4642 13.7074Z" fill="var(--bs-danger)"/>
												</svg>
											</div>
										</div>
		...
		<div class="footer">
			<div class="copyright text-center">
			   <p class="mb-0">Copyright © Food Park. Theme by <a href="https://dexignzone.com/" target="_blank">DexignZone</a> <span class="current-year">@php echo date('Y') @endphp</span></p>
			</div>
		</div>
		<!-- End - Footer -->
	...
	<script src="{{ asset('admin/assets/vendor/metismenu/dist/metisMenu.min.js') }}"></script>
	<script src="{{ asset('admin/assets/vendor/@yaireo/tagify/dist/tagify.js') }}"></script>

	<!-- Script For apexchart -->
	<script src="{{ asset('admin/assets/vendor/apexcharts/dist/apexcharts.min.js') }}"></script>
	...
	<script src="{{ asset('admin/assets/vendor/i18n/i18n.js') }}"></script>
	<script src="{{ asset('admin/assets/js/translator.js') }}"></script>
